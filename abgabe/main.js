...
class Game {
    ...
    equations = [new Equation("3+6"), new Equation("1+2*4")];

    // positions for 0,1,2,3 trains
    positionsArray = [undefined, undefined, [{ x: 0, y: 0 }, { x: 0, y: 300 }, { x: 300, y: 150 }], [{ x: 0, y: 0 }, { x: 0, y: 300 }, { x: 0, y: 600 }, { x: 300, y: 150 }, { x: 300, y: 450 }, { x: 600, y: 300 }]]
    ...
    loadRound(equation) {
        ...
        for (let i = 0; i < this.trains.length; i++) {
            drawTrains.rect(150, 50).opacity(this.trains[i].visible ? 1 : 0.3).fill('#3385c4').move(positions[i].x, positions[i].y);
